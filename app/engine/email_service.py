...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;">
  ...
  <tr><td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
    ...
    <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:12px 16px;margin-bottom:28px;">
      <span style="font-size:12px;color:#1e40af;line-height:1.5;">
        <strong>✦ AI Disclaimer:</strong> This summary, decisions, and action items were automatically generated by MeetingMind AI and may contain inaccuracies. Please verify key decisions and tasks with your team.
      </span>
    </div>
  ...
  <tr><td style="background:#f9fafb;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 16px 16px;padding:20px 40px;text-align:center;">
    <p style="margin:0 0 6px 0;font-size:12px;color:#9ca3af;line-height:1.6;">
    ...
    <p style="margin:0;font-size:11px;color:#9ca3af;line-height:1.5;">
      AI-generated content may be inaccurate or incomplete. Always verify critical information.
    </p>
  </td></tr>
